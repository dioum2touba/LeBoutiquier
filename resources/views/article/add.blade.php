                ...
                <div class="card-body">
                    <form method="POST" action="{{ route('storeArticle') }}">
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="codeGeneral" type="text" class="form-control @error('codeGeneral') is-invalid @enderror" name="codeGeneral" value="{{ old('codeGeneral') }}" required autocomplete="codeGeneral" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="codeBare" type="text" class="form-control @error('codeBare') is-invalid @enderror" name="codeBare" value="{{ old('codeBare') }}" required autocomplete="codeBare" autofocus>
                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="conditionnement" type="text" class="form-control @error('conditionnement') is-invalid @enderror" name="conditionnement" value="{{ old('conditionnement') }}" required autocomplete="conditionnement" autofocus>
                         ...
                         <div class="form-group row">
                            ...
                            <div class="col-md-6">
                                <input id="quantite" type="number" class="form-control @error('quantite') is-invalid @enderror" name="quantite" value="{{ old('quantite') }}" required autocomplete="quantite" autofocus>
